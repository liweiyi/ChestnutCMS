 ...
 * 第三方登录回调跳转地址
 */
@Component(FixedConfig.BEAN_PREFIX + LoginRedirectURL.ID)
public class LoginRedirectURL extends FixedConfig {

	public static final String ID = "LoginRedirectURL";

	private static final ISysConfigService configService = SpringUtils.getBean(ISysConfigService.class);

	private static final String DEFAULT_VALUE = "http://localhost/";
