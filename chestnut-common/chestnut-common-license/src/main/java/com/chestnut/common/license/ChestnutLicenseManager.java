package com.chestnut.common.license;

import com.chestnut.common.license.model.LicenseExtraParam;
import com.chestnut.common.license.server.AServerInfos;
 ...
 */
@Slf4j
public class ChestnutLicenseManager extends LicenseManager {
    ...
    public ChestnutLicenseManager(LicenseParam param) {
        super(param);
    }
    ...
    protected synchronized void validate(final LicenseContent content) throws LicenseContentException {
        ...
        if(now.after(notAfter)){
            throw new LicenseContentException("系统证书过期，当前时间已超过证书有效期 -- "+
                    DateUtils.parseDateToStr("yyyy-MM-dd", content.getNotAfter()));
        }
        //1、 首先调用父类的validate方法
    ...
    private boolean checkIpAddress(List<String> expectedList, List<String> serverList){
        ...
        if(StringUtils.isEmpty(expectedList)){
            return false ;
        }
