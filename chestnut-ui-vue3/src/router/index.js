...
export const constantRoutes = [
  ...
  {
    path: '/loginRedirect',
    component: () => import('@/views/loginRedirect'),
    hidden: true
  },
  {
    path: '/register',
    ...
    children: [
      {
        ...
        name: 'CMSSiteTab',
        meta: { noCache: true, title: i18n.global.t('CMS.ContentCore.Route.EditSite'), activeMenu: '/configs/site'}
      },
      {
      ...
      },
      {
        ...
        meta: { noCache: true, title: i18n.global.t('CMS.ExModel.RouteExModelField'), activeMenu: '/configs/exmodel'}
      },
      {
        path: 'block/manual/editor',
        component: () => import('@/views/cms/block/manualBlockEditor'),
        name: 'CMSBlockManualEditor',
        meta: { noCache: true, title: i18n.global.t('CMS.ContentCore.Route.EditManualBlock'), activeMenu: '/configs/content'}
      },
      {
        path: 'adspace/editor',
        component: () => import('@/views/cms/ad/adSpaceEditor'),
        name: 'CMSAdSpaceEditor',
        meta: { noCache: true, title: i18n.global.t('CMS.ContentCore.Route.EditAdvSpace'), activeMenu: '/operations/advertisement'}
      },
      {
        path: 'ad/editor',
        component: () => import('@/views/cms/ad/advertisementEditor'),
        name: 'CMSAdvertisementEditor',
        meta: { noCache: true, title: i18n.global.t('CMS.ContentCore.Route.EditAdv'), activeMenu: '/operations/advertisement'}
      }
    ]
  },
  {
