const zhCN = {
  ...
  Login: {
    ...
    CaptchaClickWord: '点击文字验证码',
    CaptchaClickWordTip: '请按顺序点击文字：{0}',
    CaptchaClickWordSuccessTip: '验证成功，耗时{0}秒。',
    CaptchaSlider: '滑块拼图验证码',
    CaptchaSliderTip: '请拖动滑块完成拼图',
    CaptchaSliderSuccessTip: '验证成功，耗时{0}秒。',
  ...
  System: {
    User: {
      ...
      ImportResult: "导入结果",
      ImportTip1: "拖动文件到此处，或<em>点击上传</em>",
      ImportFileTypes: "仅支持导入.xls, .xlsx文件",
    ...
    Menu: {
      ...
      RouterParams: "路由参数",
      RouterParamsTips: '访问路由的默认传递参数，如：`{\'{\'}"id": 1, "name": "chestnut"{\'}\'}`',
      IsCache: "是否缓存",
  ...
  CMS: {
    ...
    Site: {
      ...
      Extend: {
        ...
        CatalogPageSizeTip: "小于等于0时取系统默认值：10",
    ...
    Article: {
      ...
      Markdown: {
        Placeholder: "输入内容...",
        InsertLink: "插入链接",
        InsertCatalog: "插入栏目链接",
        InsertContent: "插入内容链接",
        UploadImage: "上传图片",
        UploadVideo: "上传视频",
        UploadAudio: "上传音频",
        UploadFile: "上传文件",
  ...
  Message: {
    ...
    Event: {
      ...
      AddTitle: "添加事件",
      EditTitle: "编辑事件",
      TestEventParams: "测试事件参数",
      InnerEventSelectorTitle: "内置事件选择",
      InnerEventSelectorQueryPlaceholder: "输入ID/名称查询",
    }
  },
  Flowable: {
    Category: {
