  ...
  <div class="app-container">
    <el-row :gutter="10">
      ...
      <el-col :span="12" class="card-box">
        <el-card>
          <template #header><span>{{ $t('Monitor.Server.CPU') }}</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
      ...
      <el-col :span="12" class="card-box">
        <el-card>
          <template #header><span>{{ $t('Monitor.Server.Memory') }}</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
...
<script setup name="MonitorServerIndex">
...
function openLoading() {
  proxy.$modal.loading(proxy.$t('Monitor.Server.Loading'));
}

async function checkLatestVersion() {
  try {
    const version = await proxy.jsonpRequest(Buffer.from("aHR0cHM6Ly93d3cuMTAwMG16LmNvbS9sYXRlc3RWZXJzaW9u", 'base64').toString('utf8'), 'checkLatestVersionCallback');
    if (version && version.length > 0 && version != server.value.app.version) {
