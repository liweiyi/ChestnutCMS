...
<script setup name="CMSSiteBdSearchWordSource">
...
function loadSiteSearchWordSourceDatas() {
  if (siteOptions.value.length == 0) {
  ...
  baiduTongjiApi.getSiteSearchWordSource(queryParams).then(response => {
