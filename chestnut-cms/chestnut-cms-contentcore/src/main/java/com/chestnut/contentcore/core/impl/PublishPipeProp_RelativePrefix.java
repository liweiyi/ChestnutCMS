 ...
 */
@Component(IPublishPipeProp.BEAN_PREFIX + PublishPipeProp_RelativePrefix.KEY)
public class PublishPipeProp_RelativePrefix implements IPublishPipeProp {
	
	public static final String KEY = "RelativePrefix";
