...
@Getter 
@Setter
public class MemberContentVO implements InitByContent {
	...
	public static MemberContentVO newInstance(CmsContent cmsContent) {
		MemberContentVO vo = new MemberContentVO();
