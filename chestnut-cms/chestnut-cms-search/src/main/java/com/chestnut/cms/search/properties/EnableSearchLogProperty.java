 ...
 * 是否开启索引
 */
@Component(IProperty.BEAN_NAME_PREFIX + EnableSearchLogProperty.ID)
public class EnableSearchLogProperty implements IProperty {

	public final static String ID = "EnableSearchLog";
	...
	public static boolean getValue(Map<String, String> firstConfigProps, Map<String, String> secondConfigProps) {
